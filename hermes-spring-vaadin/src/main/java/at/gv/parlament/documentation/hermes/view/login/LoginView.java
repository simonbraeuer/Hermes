package at.gv.parlament.documentation.hermes.view.login;
...
public class LoginView extends AbstractHermesApplicationView implements
	...
	public LoginView() {
		...
		user.setInputPrompt("Geben Sie hier den Benutzernamen ein!");
		...
		fields.setCaption("Melden sie sich hier an, um Hermes zu starten!");
